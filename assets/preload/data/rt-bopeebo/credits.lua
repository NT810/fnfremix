function onCreate()
	makeLuaText('creds', songName .. " by emihead", 0, 2, 695);
	...
	makeLuaText('creds2', "Sprites by ghostfisk & JOHT0S", 0, 2, 695);
	...
	makeLuaText('creds3', "BG by Vesrimm // Chart by AdrianCD", 0, 2, 695);
